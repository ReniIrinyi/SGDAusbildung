...
public class EinfachVerketteteListe {
    ...
    static void listeAnhaengen(String datenNeu, Listenelement listenAnfang) {
        ...
        //neues Element am Ende der Liste einfügen hilfsKonstruktion.naechster = new Listenelement4();
        //Hilfskonstruktion auf das neue Element setzen hilfsKonstruktion = hilfsKonstruktion.naechster;
        //die Daten eintragen
    ...
    static void listeAusgeben(Listenelement listenAnfang) {
        ...
        Listenelement hilfsKonstruktion;
        hilfsKonstruktion = listenAnfang;
        //erstes Element ausgeben System.out.println(hilfsKonstruktion.daten);
        //und nun den Rest
        while (hilfsKonstruktion.naechster != null) {
            hilfsKonstruktion = hilfsKonstruktion.naechster;
